...
const HeroSection = () => {
  return (
    <div className="relative bg-gradient-to-r from-violet-500/10 via-fuchsia-500/10 to-amber-500/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            เชื่อมต่อ แบ่งปัน <span className="text-amber-500">เติมเต็ม</span>
          </h2>
          <p className="text-xl text-gray-600 mb-8">
            จับคู่การบริจาคของคุณกับผู้ที่ต้องการได้อย่างตรงจุด แพลตฟอร์มของเราช่วยเชื่อมโยงผู้บริจาคกับผู้รับอย่างราบรื่น ทำให้การให้มีประสิทธิภาพและเปี่ยมความหมาย
          </p>
